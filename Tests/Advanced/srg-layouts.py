...
def verify_packing_relaxed(thefile, compiler_path, silent):
    ...
    if ok:
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][3][
...
def verify_packing_direct_x(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-dx12", "--srg"])
    ...
    if ok:
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][3]["typeName"] == "/ExampleSRG/S")
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][4]["constantByteOffset"] == 32)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][4][
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][5][
...
def verify_packing_vulkan(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-vulkan", "--srg"])
    ...
    if ok:
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][15]["constantByteSize"] == 32)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][15]["typeName"] == "/ExampleSRG/S")
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][16][
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][4]["type"] == "StructuredBuffer<S>")
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][4]["count"] == 1)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][4][
                                      "stride"] == 16)  # Note that StructuredBuffers in SpirV follow the base alignment for arrays rule (align-16)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][5]["type"] == "Buffer<float2>")
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][5]["count"] == 2)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][5][
                                      "stride"] == 16)  # Note that Buffers in SpirV follow the base alignment for arrays rule (align-16)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][6]["type"] == "StructuredBuffer<S>")
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][6]["count"] == 2)
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForBufferViews"][6][
                                      "stride"] == 16)  # Note that StructuredBuffers in SpirV follow the base alignment for arrays rule (align-16)
...
def verify_structs_packing_vulkan(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-vulkan", "--srg"])
...
def verify_packing_open_gl(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-opengl", "--srg"])
...
def verify_structs_packing_open_gl(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-opengl", "--srg"])
...
def verify_packing_relaxed_use_spaces(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--srg"])
...
def verify_packing_relaxed_no_spaces(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--srg"])
...
def verify_packing_relaxed_unique_idx(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--srg", "--unique-idx"])
...
def verify_packing_relaxed_unique_idx_use_spaces(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--srg", "--unique-idx"])
...
def verify_packing_unbounded_spill_spaces(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--srg", "--namespace=dx"])
...
def verify_packing_direct_x_matrices(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-dx12", "--no-alignment-validation", "--srg"])
    ...
    if ok:
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][24][
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][49][
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][74][
        ...
        predicates.append(lambda: j["ShaderResourceGroups"][0]["inputsForSRGConstants"][110][
...
def verify_packing_vulkan_matrices(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-vulkan", "--no-alignment-validation", "--srg"])
...
def verify_packing_direct_x_stride(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-dx12", "--no-alignment-validation", "--srg"])
...
def verify_packing_direct_x_inline_constants(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--pack-dx12", "--srg", "--root-const=52"])
    ...
    if ok:
        ...
        if not silent: print(Foreground.CYAN + Style.BRIGHT + "inline constant layouts verification..." + Style.RESET_ALL)
        ok = compiler.verify_all_predicates(predicates, j)
    return True if ok else False


def verify_packing_metal_inline_constants(thefile, compiler_path, silent):
    j, ok = compiler.build_and_get_json(thefile, compiler_path, silent, ["--namespace=mt", "--srg"])
